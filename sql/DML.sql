...
-- ClassFunctionality
INSERT INTO public.class_functionality(id, name) Values (0, 'מקרן');
INSERT INTO public.class_functionality(id, name) Values (1, 'מחשבים');
INSERT INTO public.class_functionality(id, name) Values (2, 'לוח');
